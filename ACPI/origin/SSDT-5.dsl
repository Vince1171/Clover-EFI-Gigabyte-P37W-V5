 ...
 *
 * Disassembly of SSDT-5.aml, Fri Jul 20 13:03:07 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000055D2 (21970)
 *     Revision         0x02
 *     Checksum         0x98
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
     ...
     * disassembly, but only 20 were resolved (4 unresolved). Additional
    ...
    External (_SB_.SDSE, MethodObj)    // 2 Arguments
    ...
    OperationRegion (SANV, SystemMemory, 0x87B59D98, 0x0135)
